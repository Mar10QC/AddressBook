...
public class AddressBook {
    ...
    String filepath = String.format(
            "C:%sUsers%spc%sDesktop%sTecMilenio%s2020-08%sComputación en Java%sEntregables%sAddressBook%ssrc%scom%sAddressBook.txt",
        ...
        if (contactos.size() > 0) {
            ...
            while (!existente) {
                ...
                if (contactos.containsKey(numero)) {
                    ...
                    System.out.println("El número digitado no existe en AddressBook.");
                }
            }
